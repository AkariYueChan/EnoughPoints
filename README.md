...
实现的功能：像玩游戏一样点击或拖拽卡片，实现规划选课，自动计算修没修够学分的大学生痛点（不帮忙抢课）

存在的问题：
1.目前只写了中文版网页，英文版不写，谁有空去翻译奇怪的选课
2.暂未适配黑暗模式，因为前途已经很黑暗了
3.公共基础课必修58学分，但是另外9学分不知道被谁吃了
4.暂时没有适配挂科后的课表排列问题
5.暂时没有解决大专毕业后企业只招本科学历起步的问题

本项目为vibecoding成果，仅供娱乐，反正是开源的，你们想拿去改成什么样都行
提示词技巧：先整理好数据，再叫agent去干活，详细描述你需要实现什么功能、怎么排列，然后反复修正、加功能
